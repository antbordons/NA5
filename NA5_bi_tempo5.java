...
//@RequiresFullAccess
public class NA5_bi_tempo5 implements IStrategy {
...
//+----------------------------------------------------            
    ...
    if (estado_oldv[i] != estado_venta[i])
        ...
        //print (instrument +"-cambio venta hora"+calendar.get(Calendar.HOUR_OF_DAY)+" dia"+calendar.get(Calendar.DAY_OF_MONTH)+"min "+calendar.get(Calendar.MINUTE)+" Estado venta="+estado_venta[i]+" Precio="+tick.getBid()+" Banda Up="+round(kcup[i],5)+" permite="+permite_entrada[i]);
